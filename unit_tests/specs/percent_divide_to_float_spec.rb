...
describe('Valid percent divided to float - 75%') do
  it('/outputs valid percent value') do
    expect(PercentDivideToFloat.valid_percent_divide_to_float75).to eq(0.75)
  end
end

describe('Valid percent divided to float - 100%') do
  it('/outputs valid percent value') do
    expect(PercentDivideToFloat.valid_percent_divide_to_float100).to eq(1)
  end
end

describe('Valid percent divided to float - 1%') do
  it('/outputs valid percent value') do
    expect(PercentDivideToFloat.valid_percent_divide_to_float1).to eq(0.01)
  end
end
