...
BROWSERSTACKUSER = ENV['BROWSERSTACKUSER'] ? ENV['BROWSERSTACKUSER'].to_str : nil
BROWSERSTACKKEY = ENV['BROWSERSTACKKEY'] ? ENV['BROWSERSTACKKEY'].to_str : nil
BROWSERSTACKSERVER = ENV['BROWSERSTACKSERVER'] ? ENV['BROWSERSTACKSERVER'].to_str : nil
